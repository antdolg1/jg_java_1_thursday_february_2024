...
public class CarApp {
    public static void main(String[] args) {
        ...
        System.out.println(STR."Car 1 new model = \{Car1.getModel()}");
        System.out.println(STR."Car 1 new color = \{Car1.getColor()}");
        System.out.println(STR."Car 1 new price = \{Car1.getPrice()}");

        System.out.println(STR."Car 2 new model = \{Car2.getModel()}");
        System.out.println(STR."Car 2 new color = \{Car2.getColor()}");
        System.out.println(STR."Car 2 new price = \{Car2.getPrice()}");

        System.out.println(STR."Car 3 new model = \{Car3.getModel()}");
        System.out.println(STR."Car 3 new color = \{Car3.getColor()}");
        System.out.println(STR."Car 3 new price = \{Car3.getPrice()}");
