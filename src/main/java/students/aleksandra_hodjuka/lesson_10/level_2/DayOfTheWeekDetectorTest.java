...
public class DayOfTheWeekDetectorTest {
    ...
    public static void testValidInput(DayOfTheWeekDetector detector, int number, String expected) {
    ...
    public static void testInvalidInput(DayOfTheWeekDetector detector, int number, String expected) {
        String result = detector.detectDayName(number);
        if (result.equals(expected)) {
            System.out.println("Test passed  " + number);
        } else {
