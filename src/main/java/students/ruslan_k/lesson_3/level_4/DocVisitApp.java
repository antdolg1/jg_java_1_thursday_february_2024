...
//--------------------------------Make selection of Doc to visit--------------------------------------------------------
                        System.out.println("/--------------------------------------");
                        System.out.println("Сегодня в нашей психушке идёт запись на прием к следующим ведущим специалистам:");
...
//------------------------------------------------------------------------------------------------------------
                                ...
                                if (Objects.equals(visitSelect, "AM"))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        System.out.println("Пардоньте, запись только на " + visitSelect);
                                    }
                                }
